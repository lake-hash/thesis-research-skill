...
for(const [name,mutate] of [
 ...
 ['duplicate symbol',p=>p.items[0].assetBindings.push({role:'vehicle',symbol:'example',verified:true})],
 ...
 ['day-only time',p=>{p.sources[0].at='2026-09-01';p.items[0].at='2026-09-01';}],
 ['midnight cannot disguise a day-only source',p=>p.items[0].datePrecision='day'],
 ['source precision is also checked',p=>p.sources[0].datePrecision='day'],
